    ...
    subFactions: [
      {
        ...
        mechaList: [
          ...
          },
          {
            ...
            doctrineText: "「切断・精密制圧」を主眼とする。多数の斬仙剣を同時制御する術式回路を全身に内蔵し、闘域を刃線で支配する。",
            relicStory: {
              tag: "INDIVIDUAL LOG // GYOKUTEI-01",
              title: "崑崙十二仙・玉鼎門弟子",
              text: "「玉虚宮の高弟にして、斬仙剣の使い手。斬仙剣を数多く翳起し、自在に操りて敵を切断する遠距離戦闘を得意とする。崑崙十二仙の一人として数多の戦いに参した。」"
            }
          },
          {
            name: "哪吒 [NEZHA]",
            ...
            specs: [
              ...
              { label: "主装甲", value: "風雷複合装甲" },
              { label: "所属", value: "中華連合・天機軍" },
              { label: "搭乗数 / コックピット", value: "1機 / 腰部（女神型）" },
              { label: "主武装", value: "地脈励起杖（神楽鈴）" }
            ],
            doctrineTitle: "運用ドクトリン: 高機動型多重武装運用",
            doctrineText: "道教の童子と伝えられる哪吒をモチーフにした小型高機動型代代機体。六本の腕と多彩な宝貝を駆使し、近接戦闘から中距離制圧までを担う。その身は童子の装いに包まれ、軽快な機動性と高い汎用性を持つ。",
            relicStory: {
              tag: "INDIVIDUAL LOG // NEZHA-01",
              title: "蓮華の如く生まれし童子",
              text: "「少年の身に宿る無限の可能性。童子の自由と純粋さ、そして戦士としての鋭さを融合させた設計。六腕による多重操作と宝貝の同時運用で、戦場において圧倒的な柔軟性と火力を発揮する。」"
            }
          }
        ]
      },
        ...
        mechaList: [
          ...
          },
          {
            ...
            specs: [
              ...
              { label: "コクピット", value: "腹部（骨盤部に配置）" },
              { label: "主な役割", value: "都市防衛・対侵入近接迎撃・制圧" },
              { label: "主武装", value: "クロー（近接戦闘） / 高出力ライフル（中〜長距離）" }
            ],
            doctrineTitle: "運用ドクトリン: 局所防御フィールド・近接戦闘特化",
            doctrineText: "家庭と都市を守る女神。猫のしなやかさと、雌ライオンの戦闘性を併せ持ち、侵入者を許さない。その存在は、人々に安らぎと、同時に畏怖をもたらす。",
            relicStory: {
              tag: "INDIVIDUAL LOG // BASTET-01",
              title: "都市の静寂を守る影",
        ...
        mechaList: [
          ...
          },
          {
            ...
            specs: [
              ...
              { label: "所属", value: "インド神話系 ヴェーダ系" },
              { label: "操縦方式", value: "精神波同調式コクピット" }
            ],
            doctrineTitle: "全域索敵・監視・流体金属拘束ドクトリン",
            doctrineText: "千の目をもつ子の監視者にして契約と戒律の守護者。軌上の軍事衛星ネットワークと常時リンクし、全域の情報を掌握。両手の流体金属ウルミンを振るい、罪ある者を捉え、縛り、断つ。",
            relicStory: {
              tag: "INDIVIDUAL LOG // VARUNA-01",
              title: "水の監視者・千の目の契約者",
              text: "「ヴァルナの高機動性とバリア機構を継承しつつ、風の力を外部情報優位へと変換。『見過ごすこと』『縛ること』『断つこと』を中核とした戦闘思想を具現化した機体。」"
            }
          },
          {
            name: "アグニ [AGNI]",
            ...
            specs: [
              ...
              { label: "所属", value: "インド神話系 ヴェーダ系" },
              { label: "操縦方式", value: "精神波同期式コクピット" }
            ],
            doctrineTitle: "接触・着火・内部燃焼ドクトリン",
            doctrineText: "火そのものではなく「火を起こすこと」を戦闘原理とする機体。三鉤杵剣で機体の装甲を貫き、内部に火種を植え付ける。左前腕の高周波振動によって接触した対象に熱を生じさせ、内部機構を焼却する。",
            relicStory: {
              tag: "INDIVIDUAL LOG // AGNI-01",
              title: "火の神・火炎の執行者",
              text: "「アグニの神格である『浄化』『媒介』『変換』を機体運用に反映。火力で焼き尽くすのではなく、接触・刺突によって敵のエネルギーを燃焼へと変換する。」"
            }
          },
          {
            name: "ガルーダ [GARUDA]",
            ...
            specs: [
              ...
              { label: "搭乗数", value: "背中に14m級機体 2〜3機を搭載可能（サブフライトシステム）" },
              { label: "主装備", value: "肩部球体バリア発生装置 / 羽毛状装甲甲板" }
            ],
            doctrineTitle: "超大型サブフライト・圧倒的フィジカル制圧",
            doctrineText: "他セクターや同セクターの機体を最大3機まで背中に乗せて戦場へ急行する、超大型のサブフライトシステム（ヴァーハーナ）兼、圧倒的な巨体と巨大な翼・脚部で敵を圧倒する神獣型特化機。",
            relicStory: {
              tag: "INDIVIDUAL LOG // GARUDA-01",
              title: "天を駆ける、神の翼",
              text: "「圧倒的な巨大フィジカルと、神獣としての威厳で戦場を支配する。武装に頼らず、クチバシ・爪・翼・脚・胴体そのものを武器とした、インド神話に伝わるガルーダの如き、世界を渡る空の巨神である。」"
            }
          }
        ]
      },
        ...
        mechaList: [
          ...
          },
          {
            ...
            specs: [
              ...
              { label: "動力", value: "精神波動動力（地脈励起対応）" },
              { label: "搭乗数", value: "1機（女神型コクピット）" },
              { label: "主兵装", value: "地脈励起杖（神楽鈴）" }
            ],
            doctrineTitle: "運用ドクトリン: 水神支配・地脈共鳴・世界再生",
            doctrineText: "涙が生み出した水の神。その思しみは地脈を潤し、世界に再生をもたらす。悲しみは、終わりではない。それは、新たな循環の始まり。",
            relicStory: {
              tag: "INDIVIDUAL LOG // NAKISAWAME-01",
              title: "イザナギの涙から生まれた女神",
              text: "「イザナギの涙から生まれた女神。その涙はやがて水となり、地に流れ、命を育む。頭部の水鏡のフェイスは周囲に映るものをそのまま反射し、敵の姿を映し出す。」"
            }
          },
          {
            ...
            specs: [
              ...
              { label: "動力", value: "タマノオロチ式（可変精神波炉 / 断絶・掃滅補助起動対応）" },
              { label: "搭乗数", value: "1機（男神型・胸部勾玉コア操縦）" },
            ...
            relicStory: {
              ...
              text: "「踏み込みと旋回で間合いに滑り込み、展開された結界や動力ラインの根元を直接挟み切る近接断絶特化仕様。巨体の安定性と力強さを強調した直線的な機体構造を持つ。」"
            }
          }
        ]
      },
