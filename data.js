// =========================================================================
// MYTHEOGONICA // SECTOR & MECHA MASTER DATABASE
// =========================================================================
const SECTORS_DATA = [
  {
    id: "sector-greek",
  ...
  },
  {
    ...
    story: {
      ...
      title: "永久凍土の咆哮",
      text: "スカンディナヴィアの氷壁深くに埋もれていた巨躯は、周囲の熱を貪り喰うようにして再起動した。自律戦闘剣が宙を舞い、氷原を切り裂いた一撃の余波は、現代兵器の装甲板を紙のように断ち切った。"
    }
  },
  {
    id: "sector-taoism",
