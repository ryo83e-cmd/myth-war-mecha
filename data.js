        ...
        mechaList: [
          ...
          },
          {
            ...
            relicStory: {
              ...
              title: "焦土に遺された赤銅のマント",
              text: "ペロポネソス半島の地下溶岩洞窟にて発掘。機体周囲の岩盤は超高熱でガラス化しており、背部推進機関の稼働痕跡が生々しく残されていた。搭乗試験時、操者の攻撃衝動を極限まで増幅させる神経汚染パルスが観測されている。"
            }
          }
        ]
      }
        ...
        mechaList: [
          {
            ...
            specs: [
              ...
              { label: "動力コア", value: "仙人骨コア・システム（正体: 金毛犼）" },
              { label: "操縦", value: "疑似仙骨回路経由（無仙骨者/人間操縦）" },
              { label: "主要法宝", value: "金光咆哮 / 金光輪（浮遊多用途光輪） / 縛雷鎖 / 浮遊符装甲" },
              { label: "可動機構", value: "術式展開状態 ➔ 高速突進状態" }
            ],
            doctrineTitle: "運用ドクトリン: 仙人骨駆動・術式咆哮強襲",
            doctrineText: "有仙骨者に頼らず、捕縛・加工した霊獣「金毛犼」の仙人骨コアを中枢に搭載。無仙骨者（一般兵）が疑似仙骨回路を介して操縦する。コアと共鳴させた「金光咆哮」による広域精神波干渉と、多用途「金光輪」、符装甲展開による高速突進で敵陣を両断する。",
            relicStory: {
              tag: "INDIVIDUAL LOG // JINGUANGXIAN-03",
              title: "咆哮する金毛の生体核",
              text: "東シナ海海床の沈没建造物より出土。胸部装甲内部に精製・結晶化された霊獣の骨が直接埋め込まれており、起動試験時には生体の叫びのような超高周波パルスを放出して観測機器を麻痺させた。"
            }
          },
          {
