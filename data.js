        ...
        mechaList: [
          {
            ...
            relicStory: {
              ...
              title: "黄金の天翔ける隼",
              text: "王家の谷地下、反り上がった姿勢のまま密閉棺に収められていた。額のウラエウス（聖蛇）センサーが光,を捉えた瞬間、全身のラピスラズリ装甲が励起し、即時飛行可能な状態へ復元した。"
            }
          }
        ]
      },
        ...
        mechaList: [
          {
            ...
            doctrineText: "紀元前1000〜500年頃、石器から鉄器へと一気に飛躍した西アフリカ製鉄文化の始祖の力を体現。「鍛えることそのものを戦いとする」思想を持ち、打撃の衝撃熱と圧力で金属組織が密に鍛え直され、硬度と切れ味が持続的に向上する自己鍛造機構を備える。原生林.を切り拓き、戦場に新たな道を穿つ。",
            relicStory: {
